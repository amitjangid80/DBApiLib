...
import com.amit.animation.AnimLoader;
...
public class PromptDialogBox extends Dialog {
    ...
    private void initView() {
        ...
        triangleIv.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, Utils.dp2px(getContext(), 10)));
        triangleIv.setImageBitmap(createTriangel((int) (Utils.getScreenSize(getContext()).x * 0.9), Utils.dp2px(getContext(), 10)));
    ...
    private int getLogoResId(int mDialogType)
    {
        ...
        if (DIALOG_TYPE_ERROR == mDialogType) {
            return R.drawable.ic_wrong;
        }
