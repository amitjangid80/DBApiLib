...
public class PromptDialogBox extends Dialog
{
    ...
    private static final String DIALOG_DEFAULT_BUTTON_TEXT = "OK";
    ...
    private void initView()
    {
        ...
        triangleIv.setImageBitmap(createTriangle(
                (int) (DeviceUtils.getScreenSize(getContext()).x * 1.5),
        ...
        {
            mPositiveBtn.setText(DIALOG_DEFAULT_BUTTON_TEXT);
        }
