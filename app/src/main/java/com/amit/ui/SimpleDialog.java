...
public class SimpleDialog extends Dialog implements View.OnClickListener
{
    ...
    {
        TextView txtTitle = transitionsContainer.findViewById(R.id.txt_title);
    ...
    {
        TextView txtContent = transitionsContainer.findViewById(R.id.txt_content);
    ...
    private void setBtnPermanentCheck()
    {
        ...
        /*TextView txtPermanent = btnCheck.findViewById(R.id.text_btn_permanent);
        // txtPermanent.setText(builder.permanentCheckText);

        if (builder.permanentTextSize != null)
        {
            // Default value = 13dp
    ...
    {
        TextView txtConfirm = btnConfirm.findViewById(R.id.text_btn);
        ...
        if (builder.confirmTextSize != null)
        {
            // Default value = 14dp
    ...
    {
        TextView txtCancel = btnCancel.findViewById(R.id.text_btn_cancel);
        ...
        if (builder.cancelTextSize != null)
        {
            // Default value = 14dp
    ...
    private void setProgressBar(Context context)
    {
        ...
        ImageView progressGif = transitionsContainer.findViewById(R.id.image_loading);
    ...
    private void setLayout(final SimpleDialog dialog)
    {
        ...
        if (builder.showProgress)
        {
            ...
            transitionsContainer = findViewById(R.id.layout_dialog);

            layoutCancel = transitionsContainer.findViewById(R.id.layout_cancel);
            btnCancel = transitionsContainer.findViewById(R.id.btn_cancel);
        ...
        else if (builder.customView != null)
        {
            ...
            LinearLayout layoutTitleContentContainer = transitionsContainer.findViewById(R.id.layout_title_content_container);

            View gapView = transitionsContainer.findViewById(R.id.view_gap);
            btnConfirm = transitionsContainer.findViewById(R.id.btn_okay);
            btnCancel = transitionsContainer.findViewById(R.id.btn_cancel);
            btnCheck = transitionsContainer.findViewById(R.id.btn_check_permanent);
            checkbox = transitionsContainer.findViewById(R.id.check_permanent);
        ...
        else
        {
            ...
            ImageView imageGuide = transitionsContainer.findViewById(R.id.image_guide);
            View gapView = transitionsContainer.findViewById(R.id.view_gap);
            btnConfirm = transitionsContainer.findViewById(R.id.btn_okay);
            btnCancel = transitionsContainer.findViewById(R.id.btn_cancel);
            btnCheck = transitionsContainer.findViewById(R.id.btn_check_permanent);
        ...
        {
            LinearLayout layoutOutside = findViewById(R.id.layout_container);
