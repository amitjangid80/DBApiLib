...
import com.amit.animation.MorphingAnimation;
import com.amit.dbapilibrary.R;
import com.amit.drawables.CircleAnimDrawable;
import com.amit.drawables.StrokeGradientDrawable;
...
public class CircularProgressButton extends AppCompatButton implements OnAnimUpdateListener
{
    ...
    private CircleAnimDrawable mAnimatedDrawable;
    ...
    private OnAnimUpdateTimeListener onAnimationUpdateTimeListener;
    ...
    @Override
    public void onAnimValueUpdate(float value)
    {
        mCurrentSweepAngle = value;
    }

    @Override
    public void onAnimTimeUpdate(int timeElapsed, int totalDuration)
    {
        mRemainingTime = totalDuration - timeElapsed;

        if (onAnimationUpdateTimeListener != null)
        {
            onAnimationUpdateTimeListener.onAnimTimeUpdate(timeElapsed);
        }
    }
    ...
    private void initAttributes(Context context, AttributeSet attributeSet)
    {
        ...
        textSize = Integer.valueOf(part1);
    ...
    private void drawProgress(Canvas canvas)
    {
        if (mAnimatedDrawable == null)
        {
            ...
            mAnimatedDrawable = new CircleAnimDrawable(mColorIndicator, mColorProgressCancelIcon, mStrokeWidth);
    ...
    private OnAnimEndListener getProgressStateListener()
    {
        return new OnAnimEndListener()
        {
            @Override
    ...
    private OnAnimEndListener getCompleteStateListener()
    {
        return new OnAnimEndListener()
        {
            @Override
    ...
    private OnAnimEndListener getCancelStateListener()
    {
        return new OnAnimEndListener()
        {
            @Override
    ...
    private OnAnimEndListener getIdleStateListener()
    {
        return new OnAnimEndListener()
        {
            @Override
    ...
    private OnAnimEndListener getErrorStateListener()
    {
        return new OnAnimEndListener()
        {
            @Override
    ...
    private void morphProgressToIdle()
    {
        ...
        animation.setListener(new OnAnimEndListener()
        {
            @Override
            public void onAnimationEnd()
            {
    ...
    public boolean isIdle()
    {
        ...
        return getProgress() == IDLE_STATE_PROGRESS;
    }
    ...
    public boolean isErrorOrCompleteOrCancelled()
    {
        ...
        return ((getProgress() == SUCCESS_STATE_PROGRESS || getProgress() == ERROR_STATE_PROGRESS || getProgress() == CANCEL_STATE_PROGRESS));
    }
    ...
    public boolean isCancelled()
    {
        ...
        return (getProgress() == CANCEL_STATE_PROGRESS);
    }

    private OnAnimEndListener getDeterminateProgressBarCompleteStateListener()
    {
        return new OnAnimEndListener()
        {
            @Override
    ...
    public void setOnAnimationUpdateTimeListener(OnAnimUpdateTimeListener onAnimationUpdateTimeListener)
    {
